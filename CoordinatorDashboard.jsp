		      ...
		      <div class="modal-body">
		        <div class="mb-3">
						...
						<input type="text" class="form-control"
							id="exampleFormControlInput1" <%-- value="<%= name %>" --%>  name="jobTitle">
					</div>
					<div class="mb-3">
						<label for="exampleFormControlInput1" class="form-label">Company Name :</label> 
						<input type="text" class="form-control"
							id="exampleFormControlInput1" <%-- value="<%= name %>" --%> name="Compname" >
					</div>
					<div class="mb-3">
						<label for="exampleFormControlTextarea1" class="form-label">Job Description : </label>
						<textarea class="form-control"  id="exampleFormControlTextarea1" name="jobdesc"
							rows="3"><%-- <%= taskDec %> --%></textarea>
					</div>
					...
					<hr class="my-4">
			 		  ...
			 		  <div class="card text-white text-center bg-primary">
					    ...
					    <div class="card-footer">
					      <button type="button" class="btn btn-dark" action="#">View</button>
					    </div>
					  </div>
					  <br>
