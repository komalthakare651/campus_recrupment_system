...
<form name="myForm"  action="studentLoginServlet" method="post">
			<h1>
			...
			<a href="studentRegister.jsp">
				<button type="button" class="btn btn-primary ">Create account<span ></span></button>
			</a>
		</form>
	</div>
	...
	function auth(){
		var uname = document.getElementById("Username").value;
		 ...
		 if(email == "pradeepkrisna307@gmail.com" && password == "Pradeep@123")
			 {
