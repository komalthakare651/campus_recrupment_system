...
<body>
	 <div class="register-card container-fluid p-5 mt-5">
		...
		<form name="myForm" onsubmit="submitForm()" action="adminLoginServlet" method="post">
			...
			<div class="alert alert-success" role="alert" id="successfully-registered">
			  ...
			  <div class="row mt-4 mb-4">
			    <div class="col form-group">
			    	...
			    	<input type="text" class="form-control" placeholder="User name" name="userName" id="firstName"  maxlength="20" >
			    </div>
		  	...
		  	<a href="adminRegisterForm.jsp">
				<button type="button" class="btn btn-primary ">Create account<span class="fa fa-user-plus ml-2"></span></button>
			</a>
